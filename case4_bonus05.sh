...
# SLURM directives for Case 4 with bonus factors = 0.5
#SBATCH -p lrz-hgx-h100-94x4
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-task=80
#SBATCH -o autops_case4_bonus05_%j.out
#SBATCH -e autops_case4_bonus05_%j.err
...
srun enroot start --root --mount /dss/dsshome1/05/ge26sav2/autops-rl:/workspace autops-rl bash -c "
    ...
    # Run the training script for Case 4 with bonus = 0.5
    python /workspace/train_scripts/custom_trainable.py \\
    --policy PPO \\
    --checkpoint-dir /workspace/checkpoints_case4_bonus05_${SLURM_JOB_ID} \\
    --mode train \\
    --iterations 100 \\
    ...
    --duration 86400 \\
    --reward-type case4 \\
    --reward-config '{\"targets_bonus_factor\": 0.5, \"final_targets_bonus\": 0.5}'
"
