...
# SLURM directives for bonus05 benchmark
#SBATCH -p lrz-hgx-h100-94x4
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=40
#SBATCH -o autops_benchmark_bonus05_%j.out
#SBATCH -e autops_benchmark_bonus05_%j.err
...
srun enroot start --root --mount /dss/dsshome1/05/ge26sav2/autops-rl:/workspace autops-rl bash -c "
    ...
    echo '=================================================='
    echo 'STARTING BONUS05 SENSITIVITY BENCHMARK'
    echo '=================================================='
    echo 'System Info:'
    ...
    find /workspace -name 'checkpoints_case*_bonus05_*' -type d | sort
    echo 'Available checkpoint files:'
    find /workspace -name 'best_case*_seed*_sim_everyone.ckpt' | grep bonus05 | sort
    echo '=================================================='
    
    # Run bonus05 benchmark
    echo 'Running BONUS05 benchmark...'
    python /workspace/benchmark_policies_sensitivity.py \\
        --bonus-groups bonus05 \\
        --episodes 15
    
    if [ \$? -eq 0 ]; then
        echo '✓ Bonus05 benchmark completed successfully'
    else
        echo '✗ Bonus05 benchmark failed'
    fi
    ...
    if [ -n \"\$LATEST_EXPERIMENT\" ]; then
        ...
        BACKUP_DIR=\"/workspace/benchmark_results/bonus05_backup_\$TIMESTAMP\"
    ...
    echo '=================================================='
    echo 'BONUS05 BENCHMARK COMPLETE!'
    echo '=================================================='
    ...
    find /workspace/benchmark_results -name 'bonus05_backup_*' -type d | sort
    echo '=================================================='
" 