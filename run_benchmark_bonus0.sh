...
# SLURM directives for bonus0 benchmark
#SBATCH -p lrz-hgx-h100-94x4
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=40
#SBATCH -o autops_benchmark_bonus0_%j.out
#SBATCH -e autops_benchmark_bonus0_%j.err
...
srun enroot start --root --mount /dss/dsshome1/05/ge26sav2/autops-rl:/workspace autops-rl bash -c "
    ...
    echo '=================================================='
    echo 'STARTING BONUS0 SENSITIVITY BENCHMARK'
    echo '=================================================='
    echo 'System Info:'
    ...
    find /workspace -name 'checkpoints_case*_bonus0_*' -type d | sort
    echo 'Available checkpoint files:'
    find /workspace -name 'best_case*_seed*_sim_everyone.ckpt' | grep bonus0 | sort
    echo '=================================================='
    
    # Run bonus0 benchmark (no baselines needed - already done in bonus01)
    echo 'Running BONUS0 benchmark...'
    python /workspace/benchmark_policies_sensitivity.py \\
        --bonus-groups bonus0 \\
        --episodes 15
    
    if [ \$? -eq 0 ]; then
        echo '✓ Bonus0 benchmark completed successfully'
    else
        echo '✗ Bonus0 benchmark failed'
    fi
    ...
    if [ -n \"\$LATEST_EXPERIMENT\" ]; then
        ...
        BACKUP_DIR=\"/workspace/benchmark_results/bonus0_backup_\$TIMESTAMP\"
    ...
    echo '=================================================='
    echo 'BONUS0 BENCHMARK COMPLETE!'
    echo '=================================================='
    ...
    find /workspace/benchmark_results -name 'bonus0_backup_*' -type d | sort
    echo '=================================================='
" 