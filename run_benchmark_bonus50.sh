...
# SLURM directives for bonus50 benchmark
#SBATCH -p lrz-hgx-h100-94x4
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=40
#SBATCH -o autops_benchmark_bonus50_%j.out
#SBATCH -e autops_benchmark_bonus50_%j.err
...
srun enroot start --root --mount /dss/dsshome1/05/ge26sav2/autops-rl:/workspace autops-rl bash -c "
    ...
    echo '=================================================='
    echo 'STARTING BONUS50 SENSITIVITY BENCHMARK'
    echo '=================================================='
    echo 'System Info:'
    ...
    find /workspace -name 'checkpoints_case*_bonus50_*' -type d | sort
    echo 'Available checkpoint files:'
    find /workspace -name 'best_case*_seed*_sim_everyone.ckpt' | grep bonus50 | sort
    echo '=================================================='
    
    # Run bonus50 benchmark
    echo 'Running BONUS50 benchmark...'
    python /workspace/benchmark_policies_sensitivity.py \\
        --bonus-groups bonus50 \\
        --episodes 15
    
    if [ \$? -eq 0 ]; then
        echo '✓ Bonus50 benchmark completed successfully'
    else
        echo '✗ Bonus50 benchmark failed'
    fi
    ...
    if [ -n \"\$LATEST_EXPERIMENT\" ]; then
        ...
        BACKUP_DIR=\"/workspace/benchmark_results/bonus50_backup_\$TIMESTAMP\"
    ...
    echo '=================================================='
    echo 'BONUS50 BENCHMARK COMPLETE!'
    echo '=================================================='
    ...
    find /workspace/benchmark_results -name 'bonus50_backup_*' -type d | sort
    echo '=================================================='
" 