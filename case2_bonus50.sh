...
# SLURM directives for Case 2 with bonus factors = 5.0
#SBATCH -p lrz-hgx-h100-94x4
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-task=80
#SBATCH -o autops_case2_bonus50_%j.out
#SBATCH -e autops_case2_bonus50_%j.err
...
srun enroot start --root --mount /dss/dsshome1/05/ge26sav2/autops-rl:/workspace autops-rl bash -c "
    ...
    # Run the training script for Case 2 with bonus = 5.0
    python /workspace/train_scripts/custom_trainable.py \\
    --policy PPO \\
    --checkpoint-dir /workspace/checkpoints_case2_bonus50_${SLURM_JOB_ID} \\
    --mode train \\
    --iterations 100 \\
