...
# SLURM directives for bonus10 benchmark
#SBATCH -p lrz-hgx-h100-94x4
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=40
#SBATCH -o autops_benchmark_bonus10_%j.out
#SBATCH -e autops_benchmark_bonus10_%j.err
...
srun enroot start --root --mount /dss/dsshome1/05/ge26sav2/autops-rl:/workspace autops-rl bash -c "
    ...
    echo '=================================================='
    echo 'STARTING BONUS10 SENSITIVITY BENCHMARK'
    echo '=================================================='
    echo 'System Info:'
    ...
    find /workspace -name 'checkpoints_case*_bonus10_*' -type d | sort
    echo 'Available checkpoint files:'
    find /workspace -name 'best_case*_seed*_sim_everyone.ckpt' | grep bonus10 | sort
    echo '=================================================='
    
    # Run bonus10 benchmark
    echo 'Running BONUS10 benchmark...'
    python /workspace/benchmark_policies_sensitivity.py \\
        --bonus-groups bonus10 \\
        --episodes 15
    
    if [ \$? -eq 0 ]; then
        echo '✓ Bonus10 benchmark completed successfully'
    else
        echo '✗ Bonus10 benchmark failed'
    fi
    ...
    if [ -n \"\$LATEST_EXPERIMENT\" ]; then
        ...
        BACKUP_DIR=\"/workspace/benchmark_results/bonus10_backup_\$TIMESTAMP\"
    ...
    echo '=================================================='
    echo 'BONUS10 BENCHMARK COMPLETE!'
    echo '=================================================='
    ...
    find /workspace/benchmark_results -name 'bonus10_backup_*' -type d | sort
    echo '=================================================='
" 