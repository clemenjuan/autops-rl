...
```
cd existing_repo
git remote add origin https://gitlab.lrz.de/clemente.juan/masterthesis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.lrz.de/clemente.juan/masterthesis/-/settings/integrations)
